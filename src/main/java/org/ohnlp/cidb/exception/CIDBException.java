...
/**
 * Exception class for the tool
 * @author Kavishwar Wagholikar (waghsk)
 *
 */
public class CIDBException extends Exception{

/**
 * Default constructor - initializes instance variable to unknown
 */
public CIDBException()
  {
 ...
 */
  ...
  public CIDBException(String err)
  {
    super(err);     // call super class constructor
  }

  public CIDBException(Exception e)
  {
